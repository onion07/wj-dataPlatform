        ...
        var APP = {
           ...
           /**************************  初始化入口  **************************/
            ...
            getData : function (o){
                ...
                // DOM 事件
                setTimeout(function () {
                    _ts.handle(ret1,ret2,ret3,ret4,ret5,ret6);
                },500);
                
            },
            // DOM 事件
            handle : function (ret1,ret2,ret3,ret4,ret5,ret6) {
                var _ts = this;
                // 健康值和毛率切换
                 // _ts.getTab();

                 //左下角 ‘显示’，‘隐藏’
                 _ts.isShow(ret1,ret2,ret3,ret4,ret5,ret6);
                 // ‘今日、本周、本月、今年 ’切换
                 _ts.changeView();
                 // _ts.reLoad();
            },
            ...
            // 左下角：显示隐藏事件
            isShow : function (ret1,ret2,ret3,ret4,ret5,ret6) {
                    var _ts = this,
                        _btn = $('#hs-lock'),
                        index = 0,
                        y = ['显示','隐藏'];
                    ...
                    // console.info(!ret5);
                    if (!ret1 || !ret2 || !ret3 || !ret4 || !ret5 || !ret6) {  console.warn('部分数据请求失败！'); return false;}
                    _btn.click(function () {
                        // 清除所有定时器
                        _ts.clearIntor();
                        //隐藏
...
// console.info(ret9.series[2].data[i] + '\n' +ret9.series[5].data[i]);
