        ...
        var APP = {
            ...
            _scale : function (ret1){
                    ...
                    if (_ts.pro_Lock) { 
                        ...
                        // 获取宽度，设置宽度
                        var _w = $('#outer1 .label li').outerWidth() * len;
            ...
            _intrate : function (ret2){
                    ...
                    if (_ts.pro_Lock) { 
                        ...
                        // 获取宽度，设置宽度
                        var _w = $('#outer2 .label li').outerWidth() * len;
...
// console.info(mapSeriseData)
            ...
            _sell_Scale : function (ret3){
                    ...
                    if (_ts.pro_Lock) { 
                        ...
                        // 获取宽度，设置宽度
                        var _w = $('#outer3 .label li').outerWidth() * len;
            ...
            _intrate2 : function (ret4){
                    ...
                    if (_ts.pro_Lock) { 
                        ...
                        // 获取宽度，设置宽度
                        var _w = $('#outer4 .label li').outerWidth() * len;
...
// console.info('ret6.series[0].data',ret6.series[0].data)
            ...
            _asset_size : function (ret9){
                ...
                // var _Max = 0;
                //转化为一个数组  
                // for (var i = 0,len = ret9.series.length; i < len; i++) {
                //     fData.push(ret9.series[i].data);
                // };
                // ta = fData.join(",").split(",");

                // //转化为一维数组  
                // for (var i = 0,len = ta.length; i < len; i++) {
                //     lData.push( Math.abs(ta[i]));
                // };
                // // 获取一维数组 最大值
                // _max = Math.max.apply(null,lData);
                // _min = _max * -1;
                // console.info(_max);
                // 
                // console.info(ret9.series[2].data+'\n'+ret9.series[5].data);
                // console.info(ret9.series[3].data+'\n'+ret9.series[4].data);
                ...
                for (var i = 0,len = ret9.series[0].data.length; i < len; i++) {
                    ...
                    // lData.push(leftData);
                    // rData.push(rightData);
                    lrData.push( Math.abs(leftData));
                    lrData.push( Math.abs(rightData));
                };
                // lrData.push(lData)
                // lrData.push(rData)
                    console.info('lrData',lrData)
                    _Max = Math.max.apply(null,lrData);
                    _Min = _Max * -1;
                    console.info(_Max)
